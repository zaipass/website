...
class EnProductType(models.Model):
...
class EnProduct(models.Model):
    ...
    name = models.CharField(max_length=255,
                            ...
                            verbose_name='药品名称',
                            help_text='药品名称')
    composition = models.TextField(verbose_name='药品成分',
                                   help_text='药品成分')
    ...
    standard = models.CharField(max_length=255,
                                verbose_name='规格',
                                help_text='规格')
    main = models.TextField(verbose_name='主要功效',
                            help_text='主要功效')
