...
from apps.article.models import (
    ...
    EnArticles, EnArticleType, EnCertificate
)


@admin.register(EnArticles)
class EnArticlesAdmin(admin.ModelAdmin):
...
@admin.register(EnArticleType)
class EnArticleTypeAdmin(admin.ModelAdmin):
    list_display = ('typename', 'create_time')


@admin.register(EnCertificate)
class EnCertificateAdmin(admin.ModelAdmin):
